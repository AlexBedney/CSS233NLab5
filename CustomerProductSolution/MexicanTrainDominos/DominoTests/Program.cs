    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            TestDeckConstructors();
            TestDrawAndShuffle();
            TestIsEmpty();
        }

        static void TestDeckConstructors()
        {
            BoneYard by1 = new BoneYard(6);
            BoneYard by2 = new BoneYard(12);

            Console.WriteLine(by1[1].ToString());
            Console.WriteLine(by1[1].ToString());
            Console.WriteLine(by2[1].ToString());
            Console.WriteLine(by2[1].ToString());

            Console.WriteLine(by1.DominosRemaining);
            Console.WriteLine(by2.DominosRemaining);

            Console.WriteLine(by1.ToString());
            Console.WriteLine(by2.ToString());
        }

        static void TestDrawAndShuffle()
        {
            BoneYard by1 = new BoneYard(6);

            Console.WriteLine(by1.Draw());
            by1.Shuffle();
            Console.WriteLine(by1.ToString());
        }
        ...
        {
            BoneYard by1 = new BoneYard();

            Console.WriteLine(by1.ToString());
            Console.WriteLine(by1.IsEmpty());
        }

        //Old methods from previous labs
